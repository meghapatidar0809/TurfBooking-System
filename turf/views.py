...
def turf_dewas(request):
    if request.user.is_authenticated:
        username = request.user.username
        return render(request, 'turf_dewas.html', {'username':username})
    return render(request, 'turf_dewas.html')

def turf_indore(request):
    if request.user.is_authenticated:
        username = request.user.username
        return render(request, 'turf_indore.html', {'username':username})
    return render(request, 'turf_indore.html')

def turf_ujjain(request):
    if request.user.is_authenticated:
        username = request.user.username
        return render(request, 'turf_ujjain.html', {'username':username})
    return render(request, 'turf_ujjain.html')

def turf_bhopal(request):
    if request.user.is_authenticated:
        username = request.user.username
        return render(request, 'turf_bhopal.html', {'username':username})
    return render(request, 'turf_bhopal.html')

def turf_details_d1(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_d1.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_d2(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_d2.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_d3(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_d3.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_i1(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_i1.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_i2(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_i2.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_i3(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_i3.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_i4(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_i4.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_i5(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_i5.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_i6(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_i6.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_i7(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_i7.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_u1(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_u1.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_u2(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_u2.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_u3(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_u3.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_u4(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_u4.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_b1(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_b1.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_b2(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_b2.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_b3(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_b3.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_b4(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_b4.html', {'currentDate': currentDate, 'endDate': endDate})

def turf_details_b5(request):
    currentDate = date.today().strftime("%Y-%m-%d")
    endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
    return render(request, 'turfblog_b5.html', {'currentDate': currentDate, 'endDate': endDate})
...
def slot_details(request):
    ...
    return render(request, 'slotbooking.html',{'selectedDate': selectedDate} )
...
def slot_details(request):
    if request.method == 'POST':
        selectedDate = request.POST['selectedDate']
        # Store selectedDate in session
        request.session['selectedDate'] = selectedDate
        bookedSlots = request.POST.getlist('bookedSlots')
    currentDate = datetime.now().strftime("%Y-%m-%d")   
    '''slots = turfBooking.objects.all()
    ...
    print("Matrix After")
    print(matrix.week)'''
    return render(request, 'slotbooking.html', {'selectedDate': selectedDate,'currentDate': currentDate, 'bookedSlots': bookedSlots})
...
def turfDateSelection(request):
    ...
    if request.method == 'POST':
        ...
        #print(currentDate)
        endDate = (date.today() + timedelta(days=6)).strftime("%Y-%m-%d")
        return render(request, 'turfDateSelection.html', {'selectedDate': selectedDate,'currentDate': currentDate, 'endDate': endDate})
...
def turfBilling(request):
    ...
    if request.method == 'POST':
        ...
        bookedSlots = request.POST.getlist('bookedSlots')
        list_of_input_ids = request.POST.getlist('bookedSlots')
        ...
        bookedSlots = []
        for i in range(1, 16):
            slot = request.POST.get(f'bookedSlots{i}', '')  # Retrieve value of each hidden input field
            if slot:
        ...
        print("BookedSlots :")
        print(bookedSlots)
        totalAmount = len(bookedSlots) * 1000
        if totalAmount < 1000:  # Minimum amount is 1.00 INR (100 paisa)
            totalAmount = 1000
        details = {
            'username': request.user.username,
        ...
        turf.save()
        return render(request, 'turfBilling.html', { 'payment': payment, 'details': details,'bookedSlots':bookedSlots,'selectedDate': selectedDate })
...
class success(View):
    def post(self, request, *args, **kwargs):
        ...
        razorpay_webhook_secret = 'rzp_test_9e8xrjzBFp5O7M'
        ...
        if hmac.compare_digest(provided_signature, expected_signature):
            ...
            if payload.get('event') == 'payment.captured':
                ...
                # Perform further actions such as updating the database, sending emails, etc.
                return HttpResponse("Payment Successful")
            else:
                # Handle other types of events if necessary
                return HttpResponse("Unhandled event type")
        else:
